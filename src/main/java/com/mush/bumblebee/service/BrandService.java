...
public interface BrandService {
    String registerBrand(Brand brand) throws SQLException, ClassNotFoundException, IOException;
    ...
    String updateBrand(Brand brand) throws SQLException, IOException, ClassNotFoundException;
